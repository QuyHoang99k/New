                                    ...
                                    <div class="tab-content" id="v-pills-tabContent">
                                        <div class="pt_0 tab-pane fade show active" id="v-1" role="tabpanel"
                                            ...
                                            <div class="form-group mb-3">
                                                <label>New Ticker Total</label>
                                                <input type="text" class="form-control" name="new_ticker_total"
                                                    value="{{ $setting_data->new_ticker_total }}">
                                            </div>
                                            <div class="form-group mb-3">
                                                <label>Status</label>
                                                <select name="status" class="form-control">
                                                    <option value="Show" @if ($setting_data->status == 'Show') selected @endif>
                                                        Show</option>
                                                    <option value="Hide" @if ($setting_data->status == 'Hide') selected @endif>
                                                        Hide</option>
                                                </select>
                                            </div>
                                        </div>

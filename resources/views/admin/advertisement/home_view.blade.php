...
@section('heading', 'Home Advertiments')
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                <label>URL</label>
                                <input type="text" value="{{ $home_ad_data->above_search_ad_url }}" class="form-control"
                                    name="above_search_ad_url" value="">
                            </div>
                            <div class="form-group mb-3">
                                <label>Status</label>
                                <select name="above_search_ad_status" class="form-control" id="">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ $home_ad_data->above_footer_ad_url }}" name="above_footer_ad_url"
                                        value="">
                                </div>
                                <div class="form-group mb-3">
                                    <label>Status</label>
                                    <select name="above_footer_ad_status" class="form-control" id="">

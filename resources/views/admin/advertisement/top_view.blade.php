...
@section('heading', 'Top Advertiments')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div>
                                    <img src="{{ asset('admin/uploads/' . $top_ad_data->top_ad) }}" alt=""
                                        style="width:100%">
                                </div>
                            </div>
                            <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3">
                                <label>URL</label>
                                <input type="text" value="{{ $top_ad_data->top_ad_url }}" class="form-control"
                                    name="top_ad_url" value="">
                            </div>
                            <div class="form-group mb-3">
                                <label>Status</label>

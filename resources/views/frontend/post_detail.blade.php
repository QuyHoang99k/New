                    ...
                    <nav class="breadcrumb-container">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                {{ $post_detail->SubCategory->Category->category_name }}</li>
                            <li class="breadcrumb-item active" aria-current="page">
                                {{ $post_detail->SubCategory->sub_category_name }}</li>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-6">
                    <div class="featured-photo">
                        <img src="{{ asset('admin/uploads/' . $post_detail->post_photo) }}" alt="">
                    </div>
                    <div class="sub">
                        <div class="item">
                        ...
                        <div class="item">
                            ...
                            <a href=""> {{ $post_detail->SubCategory->sub_category_name }}</a>
                        </div>
                        <div class="item">

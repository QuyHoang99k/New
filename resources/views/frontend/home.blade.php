...
@section('main_content')
    @if ($setting_data->status == 'Show')
        <div class="news-ticker-item">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="acme-news-ticker">
                            <div class="acme-news-ticker-label">Tin Hót !!!!</div>
                            <div class="acme-news-ticker-box">
                                <ul class="my-news-ticker">
                                    @php $i=0; @endphp
                                    @foreach ($post_data as $item)
                                        @php $i++; @endphp
                                        @if ($i > $setting_data->new_ticker_total)
                                        @break
                                    @endif
        ...
        <div class="row g-2">
            <div class="col-lg-8 col-md-12 left">
                ...
                <div class="inner">
                    <div class="photo">
                        <div class="bg"></div>
                        <img src="{{ asset('admin/uploads/' . $item->post_photo) }}" alt="">
                        <div class="text">
                            <div class="text-inner">
                                <div class="category">
                                    <span
                                        class="badge bg-success badge-sm">{{ $item->SubCategory->sub_category_name }}</span>
                                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            @if ($home_ad_data->above_search_ad_url == '')
                <img src="{{ asset('admin/uploads/' . $home_ad_data->above_search_ad) }}" alt=""
                    style="height: 150px">
            @else
                <a href="{{ $home_ad_data->above_search_ad_url }}"><img
                        src="{{ asset('admin/uploads/' . $home_ad_data->above_search_ad) }}" alt=""
    ...
    <div class="row">
        <div class="col-md-12">
            @if ($home_ad_data->above_footer_ad_url == '')
                <img src="{{ asset('admin/uploads/' . $home_ad_data->above_footer_ad) }}" alt="">
            @else
                <a href="{{ $home_ad_data->above_footer_ad_url }}"><img
                        src="{{ asset('admin/uploads/' . $home_ad_data->above_footer_ad) }}" alt=""></a>
            @endif

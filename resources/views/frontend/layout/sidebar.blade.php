<div class="sidebar">
    ...
    <div class="widget">
        <div class="widget">
            @foreach ($global_sidebar_top_data as $row)
                @if ($row->sidebar_ad_url == '')
                    <img width="360" height="250" src="{{ asset('admin/uploads/' . $row->sidebar_ad) }}" alt="">
                @else
                    <a href="{{ $row->sidebar_ad_url }}"><img width="360" height="250"
                            src="{{ asset('admin/uploads/' . $row->sidebar_ad) }}" alt=""></a>
                @endif
            @endforeach
        </div>
    ...
    <div class="widget">
        @foreach ($global_sidebar_bottom_data as $row)
            @if ($row->sidebar_ad_url == '')
                <img width="360" height="250" src="{{ asset('admin/uploads/' . $row->sidebar_ad) }}" alt="">
            @else
                <a href="{{ $row->sidebar_ad_url }}"><img width="360" height="250"

                    ...
                    @if ($global_top_ad_data->top_ad_status == 'Show')
                        <div class="ad-section-1">
                            @if ($global_top_ad_data->top_ad_url == '')
                                <img src="{{ asset('admin/uploads/' . $global_top_ad_data->top_ad) }}" alt=""
                                    style="height: 100px">
                            @else
                                <a href="{{ $global_top_ad_data->top_ad_url }}"><img
                                        src="{{ asset('admin/uploads/' . $global_top_ad_data->top_ad) }}" alt=""

...
class AdminAdvertisementsController extends Controller
{
    ...
    public function home_ad_update(Request $request)
    {
        ...
        return redirect()->back()->with('success', 'Cập Nhật Quảng Cáo Thành Công');
    }
    ...
    public function sidebar_ad_store(Request $request)
    {
        $request->validate([
            ...
            'sidebar_ad.required' => ' Ảnh không được bỏ trống'
        ]);
        $now = time();
        ...
        return redirect()->back()->with('success', 'Thêm Mới Quảng Cáo Thành Công');
    }
    ...
    public function sidebar_ad_update(Request $request, $id)
    {
        ...
        return redirect()->route('admin_sidebar_ad_show')->with('success', 'Cập Nhật Quảng Cáo Thành Công');
    }
